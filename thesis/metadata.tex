...
\def\Abstract{
As cities grow and traffic congestion worsens, traffic signal optimization becomes an increasingly important real-world problem for ensuring efficient urban mobility.
This thesis explores a simplified version of the problem, originally presented in the Google Hash Code competition.
...
\def\ThesisKeywords{%
% \xxx{keyword\sep key phrase} \sep
